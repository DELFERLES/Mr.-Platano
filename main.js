...
function updateMaterialesDate() {
  const dateElement = document.getElementById('materialesDate');
  if (dateElement) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  updateSummary();
  updateMaterialesDate(); // Call the function to display the current date
});

// --- Imprimir factura como PDF ---
// No longer needed, as print button is removed.
...
function updateSummary() {
  ...
  resumenHTML += `<div class="line" style="background:#ffe955;color:#23551e;border-radius:8px;padding:0.11em 0.45em;margin:0.14em 0;">
  ...
  if (numPackages > 0) {
    ...
    resumenHTML += `<div class="line" style="background:#ffe955da;color:#125204;border-radius:8px;padding:0.13em 0.53em;font-weight:700;">
